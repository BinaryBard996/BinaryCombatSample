...
UAsyncAction_ListenForGameplayMessage* UAsyncAction_ListenForGameplayMessage::ListenForGameplayMessagesToActor(
	AActor* TargetActor, FGameplayTag Channel, UScriptStruct* PayloadType, EGameplayMessageMatch MatchType)
{
	...
	Action->MessageStructType = PayloadType;
	Action->MessageMatchType = MatchType;
	Action->bListenForTargetActor = true;
